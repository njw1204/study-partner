<?php
    ...
    $query = "SELECT COUNT(*) FROM studypartner_user_study WHERE id='$apply_id' AND study_no='$study_no'";
    ...
    $query = "DELETE FROM studypartner_study_apply WHERE id='$apply_id' AND study_no='$study_no'";
    $res = mysqli_query($conn, $query);
    if ($res) {
    ...
    if ($accept == "T") {
        $query = "INSERT INTO studypartner_user_study (study_no, id, msg) VALUES ('$study_no', '$apply_id', '프로필 메시지가 없습니다.')";
        $res = mysqli_query($conn, $query);
        if ($res) {
